// ============================================================
// POST /api/analyze-email — Analyse synchrone d'UN email
// Même logique que manual-poll (timeout=26s sur Netlify Pro).
// ============================================================
...
export default async function handler(req: Request) {
  ...
  try {
    ...
    // Si l'email est déjà en DB, on renvoie la row immédiatement
    ...
    // Lancer l'analyse synchrone (même logique que manual-poll)
